      ...
      <main className='pt-20 lg:pt-24'>
        ...
        <section className='section-dark py-12 lg:py-16'>
          <div className='container mx-auto px-4'>
            ...
            <p className='max-w-2xl text-lg text-dark-muted'>{t('blogPage.pageDescription')}</p>
          </div>
        </section>
            ...
            <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3'>
              {blogPosts.map((post) => (
                <Link key={post.id} to={paths.blog.getPost(post.slug)} className='group block'>
                  <article className='flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:border-cyan/30 hover:shadow-card'>
                    {/* Post Image */}
                    ...
                    <div className='flex grow flex-col p-6'>
                      ...
                      <h2 className='mb-3 text-xl font-semibold text-foreground transition-colors group-hover:text-cyan'>
                      ...
                      <div className='flex items-center justify-between border-t border-border pt-4'>
                        ...
                        <ArrowRight className='size-4 text-cyan opacity-0 transition-opacity group-hover:opacity-100' />
                      </div>
                    </div>
                  </article>
                </Link>
